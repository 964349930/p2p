...
<div class="form1_nav">
  <ul>
    <li><a href="<?php echo U('Article/order');?>">新订单</a></li>
    <li><a href="<?php echo U('Article/proces');?>" class="active">处理中订单</a></li>
    <li><a href="<?php echo U('Article/details');?>">已完成订单</a></li>
    <li><a href="<?php echo U('Article/');?>">无效订单</a></li>
  </ul>  
</div>
<!-- 导航结束 -->
